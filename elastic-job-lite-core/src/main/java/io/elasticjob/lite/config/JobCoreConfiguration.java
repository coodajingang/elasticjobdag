...
public final class JobCoreConfiguration {
    ...
    public static class Builder {
        ...
        public Builder jobDagProperties(JobDagConfig jobDagConfig) {
        ...
        public final JobCoreConfiguration build() {
            ...
            return new JobCoreConfiguration(jobName, cron, shardingTotalCount, shardingItemParameters, jobParameter, failover, misfire, description, jobProperties, jobDagConfig);
        }
    }
}
